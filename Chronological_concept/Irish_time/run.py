...
def main():
    ...
    while True:
        ...
        wordinds1, wordcnts1, wordinds2, wordcnts2 = utilities.read_test(dataset_dir, mini_batch + 1)
        #(LD, ld2) = utilities.compute_perplexity(wordinds1, wordcnts1, wordinds2, wordcnts2, num_topic, n_term, n_infer, alpha, beta_minibatch, num_test)
        LD = utilities.compute_perplexity(wordinds1, wordcnts1, wordinds2, wordcnts2, num_topic, n_term, n_infer, alpha, beta_minibatch)
